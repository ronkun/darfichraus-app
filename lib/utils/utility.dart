...
class Utility {
  ...
  // Future<void> putInSharedPrefText(String prefId, String value) async {            
  //   SharedPreferences prefs = await SharedPreferences.getInstance();
  //   await prefs.setString(prefId, value);
  // }

  // Future<String> getFromSharedPrefText(String prefId) async {            
  //   SharedPreferences prefs = await SharedPreferences.getInstance();
  //   var value = prefs.getString(prefId);
  //   return value;
  // }
}
